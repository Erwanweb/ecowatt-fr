    ...
    def onHeartbeat(self):
        ...
        if self.EcoWattRequest <= now:
            ...
            if RTEDatas :
                ...
                if self.ProdNow == 0 :
                    self.J0Message = "Pas d'alerte. Production décarbonée."
                Domoticz.Debug("Prod type now is level {} and in text {}".format(str(self.ProdNow), str(self.J0Message)))
                ...
                Devices[1].Update(nValue=self.J0Value, sValue="Aujourdhui : {}".format(str(self.J0Message)))
                Devices[2].Update(nValue=self.J1Value, sValue="Demain : {}".format(str(self.J1Message)))
                Devices[3].Update(nValue=self.J2Value, sValue="{} : {}".format(J2, str(self.J1Message)))
                Devices[4].Update(nValue=self.J3Value, sValue="{} : {}".format(J3, str(self.J1Message)))

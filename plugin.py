    ...
    def onHeartbeat(self):
        ...
        if self.EcoWattRequest <= now:
            ...
            if RTEDatas :
                ...
                Domoticz.Debug("today dvalue is {} and message {}".format(str(self.J2Value), str(self.J2Message)))
                ...
                Domoticz.Debug("today dvalue is {} and message {}".format(str(self.J3Value), str(self.J3Message)))
